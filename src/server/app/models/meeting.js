module.exports = function (sequelize, DataTypes) {
  ...
  var Meeting = sequelize.define('Meeting', {
    ...
    latitude: { type: DataTypes.DOUBLE, defaultValue: null, validate: { min: -90, max: 90 }}, // Location latitude - general meeting area
    longitude: { type: DataTypes.DOUBLE, defaultValue: null, validate: { min: -180, max: 180 }}, // Location longitude - general meeting area
