module.exports = function (sequelize, DataTypes) {
  ...
  var Meeting = sequelize.define('Meeting', {
    ...
    meetingsStartDate: { type: DataTypes.TIME, allowNull: false},
    meetingsEndDate: { type: DataTypes.TIME, allowNull: false},
    ...
    participants: { type: DataTypes.JSON, defaultValue: "", allowNull: false },
